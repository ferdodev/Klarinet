        ...
        <div className="md:hidden fixed inset-0 z-50" onClick={() => setShowMoreMenu(false)}>
          ...
          >
            ...
            <button
              ...
              disabled={isClearingCache}
              className="w-full flex items-center gap-3 px-4 py-3.5 text-sm text-text-secondary hover:bg-hover hover:text-foreground transition-colors cursor-pointer disabled:opacity-50"
            >
